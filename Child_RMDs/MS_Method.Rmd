...
## Replicability
We undertook all our analyses using  ***R*** 4.0.5 [@RCitation], using a wide range of packages (see Online Supplement, `r ifelse(params$output_type_1L_chr=="Word","","Table")` A.5). We created such a dataset and distributed it via an online data repository. We distributed code, data and documentation in online repositories (see Availability of Data and Materials). 
