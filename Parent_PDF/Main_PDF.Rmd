...
abstract: |
    ...
    \textit{Objectives: } We aimed to identify the best mapping models and predictors for Assessment of Quality of Life - Six Dimensions (AQOL-6D) utility and assess the ability of mapping models to predict longitudinal change.
